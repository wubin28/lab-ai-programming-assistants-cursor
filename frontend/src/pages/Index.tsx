...
const simulateOptimization = (purpose: string, prompt: string): Promise<string> => {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              If you already know what to ask the AI and just want to make the prompt more fluent and clear, 
              then the Promptyoo-1 (where 1 means you already have an initial prompt) web application will be 
              more suitable for you. You only need to submit the original prompt to this application, and it 
              will pass the prompt to DeepSeek, optimize it according to the RABPOC model (no need to answer 6 
