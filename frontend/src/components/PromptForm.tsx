...
const PromptForm: React.FC<PromptFormProps> = ({ onOptimize, isOptimizing }) => {
        ...
        <div className="space-y-6">
          ...
          <div>
            <label htmlFor="prompt" className="block text-sm font-medium mb-2">
              Provide us the prompt you are using currently for the purpose above
            </label>
            <Textarea
              id="prompt"
              value={prompt}
          ...
          {isOptimizing && (
            <Alert variant="destructive" className="mt-4">
              <AlertDescription>
                Prompt optimization can take up to 1 minute. Please don't reload the page.
              </AlertDescription>
            </Alert>
          )}
        </div>
